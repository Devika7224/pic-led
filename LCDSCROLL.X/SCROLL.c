 ...
 * Author: 91974
 *
 * Created on 6 August, 2024, 10:24 AM
 */
...
{
                for(int i=0;i<21;i++)//ivide total 16 bit anu ullathu so athinte koode nmml kodthekkuna NAMEINTA LETTER  koode add chynm athanu for loop ilu i < kodthekkna num//
                {
                cmd(0x18);//left shift//
